...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        # Graph Array Widget
        self.graphDockWidgetArrays = QtWidgets.QDockWidget(MainWindow)
        self.graphDockWidgetArrays.setObjectName("graphDockWidgetArrays")
        self.dockWidgetContentsArrays = QtWidgets.QWidget()
        self.dockWidgetContentsArrays.setObjectName("dockWidgetContentsArrays")
        self.gridLayoutArrays = QtWidgets.QGridLayout(self.dockWidgetContentsArrays)
        self.gridLayoutArrays.setContentsMargins(11, 11, 11, 11)
        self.gridLayoutArrays.setSpacing(6)
        self.gridLayoutArrays.setObjectName("gridLayoutArrays")
        self.graphArraysLayout = QtWidgets.QVBoxLayout()
        self.graphArraysLayout.setSpacing(6)
        self.graphArraysLayout.setObjectName("graphArraysLayout")
        self.gridLayoutArrays.addLayout(self.graphArraysLayout, 0, 0, 1, 1)
        self.graphDockWidgetArrays.setWidget(self.dockWidgetContentsArrays)
        MainWindow.addDockWidget(QtCore.Qt.DockWidgetArea(2), self.graphDockWidgetArrays)
        # rest
        ...
        self.actionAddToGraphArrays = QtWidgets.QAction(MainWindow)
        self.actionAddToGraphArrays.setObjectName("actionAddToGraphArrays")
        self.actionRemoveFromGraphArrays = QtWidgets.QAction(MainWindow)
        self.actionRemoveFromGraphArrays.setObjectName("actionRemoveFromGraphArrays")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.graphDockWidgetArrays.setWindowTitle(_translate("MainWindow", "Graph-Arrays"))
        ...
        self.actionAddToGraphArrays.setText(_translate("MainWindow", "Add to Array-Graph"))
        self.actionAddToGraphArrays.setToolTip(_translate("MainWindow", "Add this node to the arrays-graph"))     
